...
const HeroSection = () => {
  ...
  return (
    <div id="home" className="w-full min-h-screen flex justify-center items-center pt-16 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-start justify-center space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white" onClick={handleOpenModal}>
              ...
              <Button
                ...
                onClick={() => window.open('https://drive.google.com/file/d/1edDH-ajgF9qH8odBo88jv1yg1-XpkVUI/view', '_blank')}
              >
                Download Resume
              </Button>
            </div>
